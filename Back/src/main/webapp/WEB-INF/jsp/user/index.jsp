...
<div class="container">
    <div class="btn-group btn-group-lg btn-r">
        <a href="${pageContext.request.contextPath}/user/insert.action?pageNow=${pageDTO.pageNow}&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}">
    ...
    <div class="row row-add">
        ...
        <div class="col-sm-4" style="margin-left: 20%;">
            <ul class="pagination" style="margin: 0 0 -5px 0;">
                <li>
                    <a class="shouye"
                       href="${pageContext.request.contextPath}/user/findUserByQuery.action?pageNow=1&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}">首页</a>
                </li>
                <li class="">
                    <a class="shang"
                       href="${pageContext.request.contextPath}/user/findUserByQuery.action?pageNow=${pageDTO.pageNow-1}&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}">上一页</a>
                </li>
                <li>
                ...
                <li>
                    <a class="xia"
                       href="${pageContext.request.contextPath}/user/findUserByQuery.action?pageNow=${pageDTO.pageNow+1}&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}">下一页</a>
                </li>
                <li>
                    <a class="weiye"
                       href="${pageContext.request.contextPath}/user/findUserByQuery.action?pageNow=${pageDTO.pages}&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}">尾页</a>
                </li>
            </ul>
        </div>
        <div class="col-sm-1" style="margin-left: 50px; padding: 0;">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <div style="display: none;">queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}</div>
                </span>
            </div>
        </div>
        <div class="col-sm-1" style="">
            ...
            <div style="display: none;">
                pageNow=${pageDTO.pageNow}&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}</div>
        </div>
    </div>
    <div class="table-responsive">
        <div class="tab-top">
            <form id="cx-form" action="${pageContext.request.contextPath}/user/findUserByQuery.action"
                ...
                <div class="input-group" style="width: 1px;">
                    ...
                    <input id="cx-name" name="queryUserName" type="text" class="form-control input-text"
                           style="width: 80px;"
                           value="${query.queryUserName}"/>
        ...
        <table class="table table-striped table-bordered" style="margin-bottom: 0;">
            ...
            <form id="ids-msg" action="${pageContext.request.contextPath}/user/deleteUserByIds.action">
                ...
                <c:forEach items="${userList}" var="user">
                    <tr style="background-color: #FFFFFF;">
                        ...
                        <td>${user.home}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/user/details.action?id=${user.id}&pageNow=${pageDTO.pageNow}&queryId=${query.queryId}&queryUserName=${query.queryUserName}&queryHome=${query.queryHome}">详情</a>&nbsp;||
