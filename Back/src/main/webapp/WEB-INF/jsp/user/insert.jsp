...
<div class="panel admin-panel margin-top">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/user/insertUser.action">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input id="zc-name" type="text" class="input w50" name="userName" value="" maxlength="8"
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input id="zc-email" type="text" class="input w50" name="email" autocomplete="off"
                           data-validate="email:邮箱格式不正确"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
