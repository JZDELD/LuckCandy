$(function () {
    ...
    $(".go").click(function () {
        ...
        if (!(parseFloat(target).toString() == "NaN")) {
            ...
            console.log(query);
            window.location.href = "/Back/house/findHouseByQuery.action?" + query;
        }
    });
    ...
    $("#clean").click(function () {
        window.location.href = "/Back/house/findHouseByQuery.action";
    });
    ...
    $(".delete").click(function () {
        ...
        if (flag) {
            if (confirm("确定要删除被选中的" + index + "个房屋？")) {
                $("#ids-msg").submit();
            }
        } else {
            alert("请选择要删除的房屋");
...
function asc(e) {
    if (confirm("确定要删除该房屋？")) {
        ...
        query = query + "&id=" + id;
        console.log(query);
        window.location.href = "/Back/house/deleteHouseById.action?" + query;
    }
}
