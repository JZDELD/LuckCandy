$(function () {
    ...
    $(".go").click(function () {
        ...
        if (!(parseFloat(target).toString() == "NaN")) {
            ...
            console.log(query);
            window.location.href = "/Back/landlord/findLandlordByQuery.action?" + query;
        }
    });
    ...
    $("#clean").click(function () {
        window.location.href = "/Back/landlord/findLandlordByQuery.action";
    });
    ...
    $(".delete").click(function () {
        ...
        if (flag) {
            if (confirm("确定要删除被选中的" + index + "个房东？")) {
                $("#ids-msg").submit();
            }
        } else {
            alert("请选择要删除的房东");
...
function asc(e) {
    if (confirm("确定要删除该房东？")) {
        ...
        query = query + "&id=" + id;
        window.location.href = "/Back/landlord/deleteLandlordById.action?" + query;
    }
}
