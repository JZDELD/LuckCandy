$(function () {
    ...
    $(".go").click(function () {
        ...
        if (!(parseFloat(target).toString() == "NaN")) {
            ...
            console.log(query);
            window.location.href = "/Back/user/findUserByQuery.action?" + query;
        }
    });
    ...
    $("#clean").click(function () {
        window.location.href = "/Back/user/findUserByQuery.action";
    });
    ...
    $(".delete").click(function () {
        ...
        if (flag) {
            if (confirm("确定要删除被选中的" + index + "个用户？")) {
                $("#ids-msg").submit();
            }
        } else {
            alert("请选择要删除的用户");
...
function asc(e) {
    if (confirm("确定要删除该用户？")) {
        ...
        query = query + "&id=" + id;
        console.log(query);
        window.location.href = "/Back/user/deleteUserById.action?" + query;
    }
}
